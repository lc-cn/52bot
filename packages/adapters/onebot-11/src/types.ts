...
export type OneBotMethodsV11 = {
  send_private_msg(params: { user_id: number; message: MessageV11.Sendable; auto_escape?: boolean,message_id?:string }): MessageV11.Ret;
  send_group_msg(params: { group_id: number; message: MessageV11.Sendable; auto_escape?: boolean,message_id?:string }): MessageV11.Ret;
  send_msg(params: {
